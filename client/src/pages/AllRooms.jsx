...
const AllRooms = () => {
    ...
    const clearFilters = () => {
        setSelectedFilters({
            roomTypes: [], // Fixed typo: was "roomType"
            priceRanges: [],
        });
        setSelectedSort(''); // Fixed: removed space
        setSearchParams({})
    }
        ...
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
                ...
                {filteredRooms.map((room, index) => (
                    <div key={index} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-400 last:pb-30 last:border-0'>
                        <img onClick={() => { navigate(`/rooms/${room._id}`); scrollTo(0, 0) }}
                            src={room.images[0]} alt="hotel-img" title='View Rooms Detail'
                    ...
                    <div className='px-5 pt-5'>
                        ...
                        {roomTypes.map((room, index) => (
                            <CheckBox 
                                ...
                                onchange={(checked, value) => handleFilterChange({ checked, value, type: 'roomTypes' })}
                            />
                        ))}
                    </div>
                    <div className='px-5 pt-5'>
                        ...
                        {priceRanges.map((range, index) => (
                            <CheckBox 
                                ...
                                onchange={(checked, value) => handleFilterChange({ checked, value: range, type: 'priceRanges' })}
                            />
                        ))}
                    </div>
